...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full font-raleway font-light dark:font-thin shadow-sm ">
      {/* Desktop View */}
      <div className="hidden md:flex justify-between items-center px-10">
        <div className="flex items-center gap-6  ">
          <div className="text-2xl font-bold bg-gradient-to-r from-[#ac7072] via-[#e6d2d1] to-[#ad7173] bg-clip-text text-transparent">
            <a href="/" className="uppercase">
              <Image src="/logo.png" alt="BDFX Logo" width={150} height={50} />
            </a>
          </div>
        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <div className="absolute top-14 -right-20 min-w-[150px] rounded shadow-lg z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none group-hover:pointer-events-auto">
              <a
      ...
      {mobileMenu && (
        <div className="md:hidden fixed top-12 left-0 w-full h-[calc(100vh-3rem)] overflow-y-auto px-4 pt-4 pb-4 z-40">
